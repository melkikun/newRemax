                                        ...
                                        <div class="row m0">
                                            ...
                                            <a :href="'property/' + prop.listUrl" style="display:block;">
                                                <div class="house-card buy">
                                                    <div class="image-wrap" :style="{ backgroundImage: 'url(' + imageUri + fil.filePreview + ')'}" v-for="fil in file" v-if="fil.id == prop.links.listFile[0]">
...
<script>
    ...
    function test(){
        var bed = $('#bed').val();
        history.pushState(null, null, 'http://premier.localhost/newRemax/public/properties?bed='+bed);
        jQuery.ajax({
          url: '',
          type: 'GET',
          dataType: 'json',
